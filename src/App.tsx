import { BarChart3, Boxes, FileText, LayoutDashboard, RotateCcw, Settings, ShoppingCart, Truck, Users } from "lucide-react";
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
              ...
              <div className="mt-8 grid gap-4 md:grid-cols-3">
                {activeCards.map((card) => {
                  ...
                  return (
                    <div className="rounded-2xl border border-slate-200 p-5" key={card.title}>
                      <CardIcon className="mb-4 h-5 w-5 text-blue-600" aria-hidden="true" />
